        ...
        <div class="m-64-x-x-x row">
          <div class="col-md-12">
            <div class="p-x-16-x-x m-16-x">
              <h2>MapAnything Dreamforce '17 Bus App</h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12 col-lg-4">
            <div class="m-16-x p-32 role-content">
              <p class="m-x-x-16-x"><strong>Role:</strong> UX and UI Design, Vision and Strategy, Creative Direction</p>
              <p class="m-x-x-16-x"><strong>Tools used:</strong> Sketch, Illustrator, Invision</p>
