<?php include 'elements/header.php'; ?>
  ...
  <main>
      ...
      <div class="m-64-x-x-x row">
  	  ...
  	  <div class="m-64-x-x-x row">
  	    <div class="col-xs-12">
            ...
            <img style="max-width: 100%;" src="img/arcgis-1.png">
  	      </div>
  	    </div>
  	  </div>
      ...
      <div class="m-64-x-x-x row">
        <div class="col-xs-12">
          <div class="p-x-16 m-16-x">
            <img style="max-width: 100%;" src="img/arcgis-2.png">
          </div>
        </div>
      </div>
      ...
      <div class="m-64-x-x-x row">
        <div class="col-xs-12">
          <div class="p-x-16 m-16-x">
            <img style="max-width: 100%;" src="img/arcgis-3.png">
          </div>
        </div>
      </div>
      ...
      <div class="m-64-x-x-x row">
        <div class="col-xs-12">
          <div class="p-x-16 m-16-x">
            <img style="max-width: 100%;" src="img/arcgis-4.png">
          </div>
        </div>
      </div>
